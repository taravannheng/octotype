...
const WordCounter: FC<WordCounterProps> = ({ wordCounterStyle, wordCounterTextStyle }) => {
  ...
  return (
    <p className={`word-counter text-h5 text-neutral-light ${wordCounterStyle}`}>WORD COUNT: <span className={`word-counter__text ${wordCounterTextStyle}`}>{wordCounter}</span></p>
  )
}
